...
class AjaxController extends Controller
{
    ...
    public function newRegister(Request $request)
    {
        ...
        if (preg_match('/^\+998\d{9}$/', $emailOrPhone)) {
            ...
            $testNumbers = ['998985666666', '998943015415', '998943015498', '998943015458', '998999999999'];
    ...
    public function confirmOtp(Request $request)
    {
        $request->validate([
            ...
            'otp' => (in_array(str_replace('+', '', $request->email), ['998985666666', '998999999999'])) ? 'required' : 'required|digits:6',
        ]);
